...
const TareaState = (props) => {
  const initialState = {
    tareas: [
      ...
      { id: 3, nombre: "Armar paleta de colores", estado: true, proyectoId: 3 },
      { id: 4, nombre: "Armar Api", estado: false, proyectoId: 2 },
      { id: 5, nombre: "Diseñar wireframe", estado: false, proyectoId: 1 },
      { id: 6, nombre: "Elegir iconos", estado: true, proyectoId: 3 },
      { id: 7, nombre: "Elegir imagenes", estado: false, proyectoId: 1 },
      { id: 8, nombre: "Elegir librerias", estado: false, proyectoId: 2 },
    ],
    tareasProyecto: null,
